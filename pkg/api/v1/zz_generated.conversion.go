...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1_ContainerStateResized_To_api_ContainerStateResized,
		Convert_api_ContainerStateResized_To_v1_ContainerStateResized,
		...
		Convert_v1_ResizeRequest_To_api_ResizeRequest,
		Convert_api_ResizeRequest_To_v1_ResizeRequest,
		Convert_v1_Resizing_To_api_Resizing,
		Convert_api_Resizing_To_v1_Resizing,
...
func autoConvert_v1_ContainerState_To_api_ContainerState(in *v1.ContainerState, out *api.ContainerState, s conversion.Scope) error {
	...
	out.Resized = (*api.ContainerStateResized)(unsafe.Pointer(in.Resized))
	return nil
}
...
func autoConvert_api_ContainerState_To_v1_ContainerState(in *api.ContainerState, out *v1.ContainerState, s conversion.Scope) error {
	...
	out.Resized = (*v1.ContainerStateResized)(unsafe.Pointer(in.Resized))
	return nil
}
...
// Convert_v1_ContainerStateResized_To_api_ContainerStateResized is an autogenerated conversion function.
func Convert_v1_ContainerStateResized_To_api_ContainerStateResized(in *v1.ContainerStateResized, out *api.ContainerStateResized, s conversion.Scope) error {
	return autoConvert_v1_ContainerStateResized_To_api_ContainerStateResized(in, out, s)
}
...
// Convert_api_ContainerStateResized_To_v1_ContainerStateResized is an autogenerated conversion function.
func Convert_api_ContainerStateResized_To_v1_ContainerStateResized(in *api.ContainerStateResized, out *v1.ContainerStateResized, s conversion.Scope) error {
	return autoConvert_api_ContainerStateResized_To_v1_ContainerStateResized(in, out, s)
}
...
func autoConvert_v1_PodSpec_To_api_PodSpec(in *v1.PodSpec, out *api.PodSpec, s conversion.Scope) error {
	...
	if err := Convert_v1_ResizeRequest_To_api_ResizeRequest(&in.ResizeRequest, &out.ResizeRequest, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_api_PodSpec_To_v1_PodSpec(in *api.PodSpec, out *v1.PodSpec, s conversion.Scope) error {
	...
	out.PriorityClassName = in.PriorityClassName
	out.Priority = (*int32)(unsafe.Pointer(in.Priority))
	if err := Convert_api_ResizeRequest_To_v1_ResizeRequest(&in.ResizeRequest, &out.ResizeRequest, s); err != nil {
		return err
	}
	return nil
}
...
// Convert_v1_ResizeRequest_To_api_ResizeRequest is an autogenerated conversion function.
func Convert_v1_ResizeRequest_To_api_ResizeRequest(in *v1.ResizeRequest, out *api.ResizeRequest, s conversion.Scope) error {
	return autoConvert_v1_ResizeRequest_To_api_ResizeRequest(in, out, s)
}
...
// Convert_api_ResizeRequest_To_v1_ResizeRequest is an autogenerated conversion function.
func Convert_api_ResizeRequest_To_v1_ResizeRequest(in *api.ResizeRequest, out *v1.ResizeRequest, s conversion.Scope) error {
	return autoConvert_api_ResizeRequest_To_v1_ResizeRequest(in, out, s)
}

func autoConvert_v1_Resizing_To_api_Resizing(in *v1.Resizing, out *api.Resizing, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1_ResizeRequest_To_api_ResizeRequest(&in.Request, &out.Request, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_Resizing_To_api_Resizing is an autogenerated conversion function.
func Convert_v1_Resizing_To_api_Resizing(in *v1.Resizing, out *api.Resizing, s conversion.Scope) error {
	return autoConvert_v1_Resizing_To_api_Resizing(in, out, s)
}

func autoConvert_api_Resizing_To_v1_Resizing(in *api.Resizing, out *v1.Resizing, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_api_ResizeRequest_To_v1_ResizeRequest(&in.Request, &out.Request, s); err != nil {
		return err
	}
	return nil
}

// Convert_api_Resizing_To_v1_Resizing is an autogenerated conversion function.
func Convert_api_Resizing_To_v1_Resizing(in *api.Resizing, out *v1.Resizing, s conversion.Scope) error {
	return autoConvert_api_Resizing_To_v1_Resizing(in, out, s)
}
...
func autoConvert_v1_ResourceRequirements_To_api_ResourceRequirements(in *v1.ResourceRequirements, out *api.ResourceRequirements, s conversion.Scope) error {
	...
	out.ResizePolicy = *(*api.ResizePolicyList)(unsafe.Pointer(&in.ResizePolicy))
	return nil
}
...
func autoConvert_api_ResourceRequirements_To_v1_ResourceRequirements(in *api.ResourceRequirements, out *v1.ResourceRequirements, s conversion.Scope) error {
	...
	out.ResizePolicy = *(*v1.ResizePolicyList)(unsafe.Pointer(&in.ResizePolicy))
	return nil
}
